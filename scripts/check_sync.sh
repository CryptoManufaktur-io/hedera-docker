...
Examples:
  ./check_sync.sh --public-rpc https://mainnet.hashio.io/api
  ./check_sync.sh --compose-service relay --public-rpc https://mainnet.hashio.io/api
  CONTAINER=relay-1 PUBLIC_RPC=https://mainnet.hashio.io/api ./check_sync.sh
EOF
}
